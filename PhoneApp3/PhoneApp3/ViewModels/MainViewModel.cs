...
namespace PhoneApp3.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public void LoadData()
        {
            ...
            this.Items.Add(new ItemViewModel() { LineOne = "Ind vs WI 05-07", LineTwo = "Ind won by 102 runs \nYour earning: +5 coins", LineThree = "" });
            this.Items.Add(new ItemViewModel() { LineOne = "Ind vs SL 02-07", LineTwo = "SL won by 161 runs \nYour earning: -3 coins", LineThree = "" });
            this.Items.Add(new ItemViewModel() { LineOne = "Ned vs Ire 07-07", LineTwo = "Ire won by 88 runs \nYou did not bet", LineThree = "" });
            this.Items.Add(new ItemViewModel() { LineOne = "Sco vs Ken 05-07", LineTwo = "Sco won by 7 wickets \nYou did not bet", LineThree = "" });
            this.Items.Add(new ItemViewModel() { LineOne = "Sco vs Ken 04-07", LineTwo = "Maecenas praesent accumsan bibendum", LineThree = "Maecenas praesent accumsan bibendum dictumst eleifend facilisi faucibus habitant inceptos interdum lobortis nascetur" });
